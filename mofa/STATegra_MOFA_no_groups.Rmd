...
if (!requireNamespace("BiocManager", quietly = TRUE))
    #install.packages("BiocManager", ver)
...
outfile = file.path(getwd(), "STATegra_output","variance_threshold","model_STATegra_no_group.hdf5")

# create mofa object without groups
